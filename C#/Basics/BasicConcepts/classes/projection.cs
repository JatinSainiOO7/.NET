...
namespace BasicConceptsClasses
{
	...
	public static class Projection
	{
        ...
        public static void ProjectionFunction()
		{
			...
			{
			new Employee { Name = "Rahul", Age = 22, City = "Delhi", Id = 121, PreCompany = "None" },
			new Employee { Name = "Dev", Age = 25, City = "Mumbai", Id = 141, PreCompany = "None" },
			new Employee { Name = "Amit", Age = 20, City = "Pune", Id = 131, PreCompany = "None" },
			new Employee { Name = "Ajay", Age = 21, City = "Agra", Id = 161, PreCompany = "None" }
			};
